...
class classifier:
	...
	def train(self,list_of_sets_of_feats,list_of_label_weights, warm_start=True):
	...
	def vec_predict_label_weights_and_confidence(self,set_of_feats):
		pass
	def vec_predict_label_weights(self,set_of_feats):
		pass
	def vec_predict_confidence(self,set_of_feats):
		pass
